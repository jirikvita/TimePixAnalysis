...
def ReadTimePixTimeData(quantity, dirname, ftag, offset):
    data = []
...
def MainCall(flightTag, offset_geiger):
    ...
    can2.cd(3)
    gr_tpxRate_vs_iframe.Draw('AL')
    can2.cd(4)
    gr_tpxE_vs_iframe.Draw('AL')
...
def MakeAndPlotGlobalGraphs(Gr_tpxRate_vs_gei, Gr_tpxE_vs_gei):
