...
rfile = ROOT.TFile('ToSort/alfa_inches/alfa14.root', 'read')
hist0 = rfile.Get('histo')

# works:
#rfile = ROOT.TFile('ToSort/bgNov13open_5ks/bgNov13open.root', 'read')
#hist0 = rfile.Get('histo')
# does not work:
#rfile = ROOT.TFile('ToSort/bgGiga13hOpen/bg11h.root', 'read')


#rfile = ROOT.TFile('/home/qitek/Dropbox/work/Prezentace/OL_Fridays/TimePix/Scans/Mrizka_atd_root/abg.root', 'read')
#hist0 = rfile.Get('abg')
#rfile = ROOT.TFile('/home/qitek/Dropbox/work/Prezentace/OL_Fridays/TimePix/Scans/Mrizka_atd_root/alfa.root', 'read')
